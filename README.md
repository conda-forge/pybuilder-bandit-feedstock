...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pybuilder-bandit-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14654&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pybuilder-bandit-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pybuilder-bandit` can be installed with:

```
conda install pybuilder-bandit
```

It is possible to list all of the versions of `pybuilder-bandit` available on your platform with:
